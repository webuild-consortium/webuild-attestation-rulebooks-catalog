...
| account_currency | [accountCurrencies](https://webuild-consortium.github.io/wp4-semantics-group/ebwv//vocabulary.html#accountCurrencies) | Currency code(s) used for the account, as defined in ISO 4217:2015. | Code list Array (3-digit code(s)) — ISO 4217:2015  [SF2.1][SF2.2]|
